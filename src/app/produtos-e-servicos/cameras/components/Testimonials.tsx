          ...
          <div className={styles.cardsContainer}>
            ...
            <div className={styles.testimonialCard}>
              <div className={styles.testimonialText}>
                ...
                <p>"Instalei em minha loja e agora monitoro tudo pelo celular."</p>
                <div className={styles.testimonialAuthor}>Tatiane, Itapuã</div>
              </div>
            ...
            <div className={styles.testimonialCard}>
              <div className={styles.testimonialText}>
                <div className={styles.stars}>★★★★★</div>
                <p>"Atendimento rápido e sem complicação."</p>
                <div className={styles.testimonialAuthor}>Valmir, Lauro de Freitas</div>
              </div>
              <div className={styles.authorImage}>|
                <Image
